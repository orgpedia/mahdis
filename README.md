# Orders of deparment of Persons with Disabilities Welfare Department Government of Maharashtra

This is a data package repository that process orders obtained from department of Persons with Disabilities Welfare Department Government of Maharasthra. The data is obtained by processing orders from Government of Maharashtra's [Orders Website](https://gr.maharashtra.gov.in/1145/Government-Resolutions) website.
...
1. [mahdis-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahdis-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
## Data Details
- **First Order:** [202301041906309635.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/202301041906309635.pdf) (04 January 2023)
- **Last Order:** [202307311337570435.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/202307311337570435.pdf) (31 July 2023)
- **Last Crawl Date:** 05-Aug-2023
- **Total Orders:** 21
- **Translated Orders:** 21
...
```
git clone https://github.com/orgpedia/mahdis.git
```
